...
const bgC= document.getElementById("LED1");
stateElement3.innerText="No Motion Detected.";
// Button Elements
...
var dbPathOutput3 = 'board1/motion/26';
...
const setupUI = (user) => {
  if (user) {
    ...
    dbRefOutput3.on('value', snap => {
        if(snap.val()==1) {
            stateElement3.innerText="Motion Detected.";
        }
        else{
            stateElement3.innerText="No Motion Detected.";
        }
